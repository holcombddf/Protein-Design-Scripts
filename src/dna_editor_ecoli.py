...
def main(sysargv=[]):
  ...
  #input file has three sections, started by lines containing ">":first section contains the amino acid sequence, second section contains the dna sequence, third section contains the amino acid changes
