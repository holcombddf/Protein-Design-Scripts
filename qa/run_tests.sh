...
run_test "dna_editor_ecoli.py 2 arguments 0-indexed" "python $DIR/dna_editor_ecoli.py --infile $TESTDIR/amino_acid_edits_0.txt --outfile $TESTDIR/outfile.txt"
run_test "dna_editor_ecoli.py 1 argument 0-indexed" "python $DIR/dna_editor_ecoli.py --infile $TESTDIR/amino_acid_edits_0.txt"
run_test "dna_editor_ecoli.py 3 arguments 1-indexed" "python $DIR/dna_editor_ecoli.py --infile $TESTDIR/amino_acid_edits_1.txt --outfile $TESTDIR/outfile.txt --index 1"
