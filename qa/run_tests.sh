...
run_test "dna_editor_ecoli.py 2 arguments" "python $DIR/dna_editor_ecoli.py --infile $TESTDIR/amino_acid_edits.txt --outfile $TESTDIR/outfile.txt"
run_test "dna_editor_ecoli.py 1 argument" "python $DIR/dna_editor_ecoli.py --infile $TESTDIR/amino_acid_edits.txt"
